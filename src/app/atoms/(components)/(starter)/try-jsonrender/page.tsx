...
export default function TryJsonRenderPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!prompt.trim() || isLoading) {
      console.log("Early return - empty prompt or loading");
      return;
    }
    console.log("Calling send with prompt string:", prompt);
    // send takes a string directly, not an object!
    await send(prompt);
